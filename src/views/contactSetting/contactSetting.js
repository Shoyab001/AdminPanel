    ...
    <>
      <CCard className="pt-4">
        ...
        <CForm className="row gx-3 gy-2 p-3 align-items-center">
          ...
          <CCol lg={6} sm={3}>
            <CFormLabel htmlFor="specificSizeInputNumber">
              <h6>Google Plus (Optional)</h6>
            </CFormLabel>
            <CFormInput id="specificSizeInputNumber" placeholder="Enter Google Plus Link" />
          </CCol>
          <CCol lg={6} sm={3}>
            <CFormLabel htmlFor="specificSizeInputNumber">
          ...
          <CCol lg={3} sm={3}>
            ...
            <CFormInput id="specificSizeInputNumber" placeholder="Enter Latitude" />
          </CCol>
          <CCol lg={3} sm={3}>
            <CFormLabel htmlFor="specificSizeInputNumber">
              <h6>Longitude</h6>
            </CFormLabel>
            <CFormInput id="specificSizeInputNumber" placeholder="Enter Longitude" />
          </CCol>
          <CCol lg={6} sm={3}>
            <CFormLabel htmlFor="specificSizeInputNumber">
              <h6>Address</h6>
